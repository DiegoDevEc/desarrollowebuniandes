...
class Productos
{
    ...
    public function insertar($Codigo_Barras, $Nombre_Producto, $Graba_IVA) //insert into productos (codigo_barras, nombre, grava_iva) values ($Codigo_Barras, $Nombre_Producto, $Graba_IVA)
    {
        try {
            $con = new ClaseConectar();
            $con = $con->ProcedimientoParaConectar();
