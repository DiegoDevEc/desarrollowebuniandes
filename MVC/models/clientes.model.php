...
class Clientes
{
    ...
    public function actualizar($Nombres, $Direccion, $Telefono, $Cedula, $Correo) //update clientes set nombre = $nombre, direccion = $direccion, telefono = $telefono, cedula = $cedula, correo = $correo where id = $id
    {
        try {
            $con = new ClaseConectar();
            $con = $con->ProcedimientoParaConectar();
